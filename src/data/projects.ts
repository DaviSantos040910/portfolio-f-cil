...
- **Interface responsiva** — funciona perfeitamente em computador, tablet e celular`,
    ...
    github_url: 'https://github.com/DaviSantos040910/ServiceFlow',
    case_study_url: null,
    is_featured: true,
    is_published: true,
...
- ✔  **Desenvolvimento pragmático com ferramentas *AI-Assisted*** prontas para acelerar resultados de freelancing e produto.`,
    ...
    github_url: 'https://github.com/DaviSantos040910/Stellarys-Styles',
    case_study_url: null,
    is_featured: true,
    is_published: true,
...
O projeto foi construído com foco em **estatégia de conversão** — cada seção da página tem um propósito claro dentro do funil: atrair atenção, apresentar valor, gerar confiança e converter em contato direto.
...
*Ideal para profissionais e empresas que desejam aumentar sua presença digital e transformar visitantes em clientes.*`,
    ...
    github_url: 'https://github.com/DaviSantos040910/Landing-Page-Business',
    case_study_url: null,
    is_featured: true,
    is_published: true,
...
*"As tecnologias aplicadas — segurança de usuários, autenticação social, gestão de banco de dados relacional e manipulação segura de APIs na nuvem — são as bases exigidas em qualquer SaaS ou Web App corporativo de sucesso."*`,
    ...
    github_url: 'https://github.com/DaviSantos040910/CommunityHub',
    case_study_url: null,
    is_featured: false,
    is_published: true,
    created_at: '2025-03-05T00:00:00.000Z',
